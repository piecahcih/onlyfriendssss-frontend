        ...
        >
            ...
            >
                ...
                <motion.div
                    ...
                    className="absolute top-10 left-10 border-4 border-green-500 text-green-500 font-black text-[14px] px-4 py-2 rounded-xl rotate-[-20deg] pointer-events-none uppercase"
                >
                    Matched my vibe :)
                </motion.div>
                <motion.div
                    style={{ opacity: useTransform(x, [-100, -50], [1, 0]) }}
                    className="absolute top-10 right-10 border-4 border-red-500 text-red-500 font-black text-[14px] px-4 py-2 rounded-xl rotate-[20deg] pointer-events-none uppercase"
                >
                    Not my vibe :(
                </motion.div>
            </motion.div>
