  ...
  return (
    <AnimatePresence>
        {isOpen && (
            ...
            className="fixed inset-0 z-200 flex flex-col bg-base-200">
                ...
                <header className="w-full top-0 sticky z-40 bg-base-200 shadow-[0_8px_32px_rgba(78,33,32,0.08)] flex items-center justify-between px-6 py-4 relative">
                    ...
                    <button type='button' onClick={onClose} 
                        className="text-primary hover:opacity-80  active:scale-95 transition-transform duration-200 relative z-10">
