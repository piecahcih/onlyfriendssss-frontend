    ...
    return (
        <div className='h-[78px] bg-primary flex justify-between pt-4 px-5'>
            ...
            <NavLink to='/profile' className="flex flex-col items-center text-white w-[50px] object-cover">
                <button onClick={logout}><img src={defaultProfile} alt="profilepic" className="rounded-full h-[30px] border border-white border-2" />
                    <p className="text-[bai-jamjuree-semibold] text-[12px]">Profile</p></button>
            </NavLink>
        </div>
    )
}
