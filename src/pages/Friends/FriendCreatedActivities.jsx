...
function FriendCreatedActivities() {
  const navigate = useNavigate();
  const { state } = useLocation();

  const activities = state?.createdActivities || [];
  const title = state?.title || "Created Activities";
...
export default FriendCreatedActivities;
