            ...
            <main className="pt-8 px-6 max-w-2xl mx-auto">
                ...
                <div className="flex items-center justify-between gap-2">
                    <div className="relative group flex-1">
                        ...
                        <input
                            className="w-full bg-white border-none outline-none ring-2 ring-primary/10 focus:ring-primary py-3 pl-14 pr-14 rounded-full font-body text-lg shadow-sm transition-all placeholder:text-on-surface/40"
                            placeholder="Find your vibe or place..."
                            type="text"
                            value={searchText}
                    ...
                    <button type='button' onClick={()=>setNotiOpen(true)} className="relative p-4 w-fit h rounded-full bg-white ring-2 ring-primary/10 shadow-sm active:scale-95 transition-all">
