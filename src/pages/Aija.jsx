...
function Aija() {
    ...
    return (
        <div className="min-h-screen bg-base-200 text-on-surface font-body pb-24">
            {/* Top Navigation Bar */}
            <header className="fixed top-0 w-full z-50 bg-base-200/80 backdrop-blur-xl px-6 py-4 flex justify-between items-center">
                <h1 className="font-headline font-bold text-2xl tracking-tight text-[#4e2120]">Activities</h1>
