    ...
    <div className="min-h-screen bg-base-200 text-neutral pb-28">
      ...
      <form onSubmit={saveEdit}>
        ...
        <main className="max-w-2xl mx-auto px-6 space-y-6">
          ...
          <button type="button" onClick={() => DeleteSwal({ currentActivity, hdlCancel })} className="w-full flex items-center justify-center underline">
            Cancel this activity</button>
